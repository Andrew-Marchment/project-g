...
export default function Home() {
  return (
    <main className="m-0 flex bg-background text-foreground">
      <Image
        src={bg}
        fill
        placeholder="blur"
      ...
      <div className="relative mx-auto p-6 text-center sm:p-4">
        <h1
          className={`${berkshireSwash.className} mb-6 text-8xl text-primary antialiased sm:mt-10 sm:text-7xl`}
        >
          Gift Guide
        </h1>
        <p
          className={`${charm.className} text-foreground-light mb-10 text-3xl antialiased md:mb-2 sm:text-2xl`}
        >
